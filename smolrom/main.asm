...
const MEMORY_TOTAL:  0x00040000
const MEMORY_USABLE: 0x0003FBF0
...
entry:
    ...
    ; put a `ret` in low memory to prevent total crashes if a jump table entry doesn't exist
    mov [0x00000000], 0x00000000
    mov.16 [0x00000004], 0xAA00
